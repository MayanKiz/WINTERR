# Telegram Automation Security Prototype

## Description

A Python prototype for Telegram automation and message delivery experiments. Because it contains keylogging-related code, it must only be used in explicitly authorized, consent-based security testing.

## Quick Start

Install the dependencies listed by the project, set credentials through environment variables, and run only in an authorized test environment. Never collect credentials or activity without explicit consent.
...
- configurable chat target.
- security-testing prototype structure.
